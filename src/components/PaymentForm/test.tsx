...
describe('<PaymentForm />', () => {
  ...
  it('should call createPaymentIntent when page is rendered and render free if freeGames is true', async () => {
  ...
  it('should call createPaymentIntent when page is rendered and render error if there is any', async () => {
